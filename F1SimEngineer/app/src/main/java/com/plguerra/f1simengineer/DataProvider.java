...
public class DataProvider extends ContentProvider {
    ...
    private static String LOGTAG = "DataProvider:";
    // Database Name for SQLITE DB
    private static final String DBNAME = "SessionDB";
    // Authority is the package name
    private static final String AUTHORITY = "com.plguerra.f1simengineer.DataProvider";
    //TABLE_NAME is defined as PhotoList
    private static final String TABLE_NAME = "SessionList";
