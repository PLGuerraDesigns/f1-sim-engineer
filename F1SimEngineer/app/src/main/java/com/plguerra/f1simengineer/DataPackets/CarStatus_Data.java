...
public class CarStatus_Data {
    short   tractionControl;        // 0 (off) - 2 (high)
    short   antiLockBrakes;         // 0 (off) - 1 (on)
    short   fuelMix;                // Fuel mix - 0 = lean, 1 = standard, 2 = rich, 3 = max
    short   frontBrakeBias;         // Front brake bias (percentage)
    short   pitLimiterStatus;       // Pit limiter status - 0 = off, 1 = on
    ...
    short   maxGears;               // Maximum number of gears
    short   drsAllowed;             // 0 = not allowed, 1 = allowed, -1 = unknown
    short   tyresWear[];            // Tyre wear percentage
    short   actualTyreCompound;	    // F1 Modern - 16 = C5, 17 = C4, 18 = C3, 19 = C2, 20 = C1
                                    // 7 = inter, 8 = wet
                                    // F1 Classic - 9 = dry, 10 = wet
                                    // F2 – 11 = super soft, 12 = soft, 13 = medium, 14 = hard
                                    // 15 = wet
    short   tyreVisualCompound;     // F1 visual (can be different from actual compound)
                                    // 16 = soft, 17 = medium, 18 = hard, 7 = inter, 8 = wet
                                    // F1 Classic – same as above
                                    // F2 – same as above
    short   tyresDamage[];          // Tyre damage (percentage)
    short   frontLeftWingDamage;    // Front left wing damage (percentage)
    short   frontRightWingDamage;   // Front right wing damage (percentage)
    short   rearWingDamage;         // Rear wing damage (percentage)
    short   engineDamage;           // Engine damage (percentage)
    short   gearBoxDamage;          // Gear box damage (percentage)
    short   vehicleFiaFlags;	    // -1 = invalid/unknown, 0 = none, 1 = green
                                    // 2 = blue, 3 = yellow, 4 = red
    float   ersStoreEnergy;         // ERS energy store in Joules
    short   ersDeployMode;          // ERS deployment mode, 0 = none, 1 = low, 2 = medium
